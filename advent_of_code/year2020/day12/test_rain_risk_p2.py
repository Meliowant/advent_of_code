    ...
    [
        {
            ...
            "args": None,
            "expected_repr": (
                "<FerryX(x_pos='0', y_pos='0', facing='6', "
                "wp_x_pos='10', wp_y_pos='1')>"
            ),
        },
        {
            "test_name": "Custom constructor",
            "args": {"facing": "45", "wp_x_pos": 5, "wp_y_pos": 5},
            "expected_repr": (
                "<FerryX(x_pos='0', y_pos='0', facing='45', "
...
def test_ferryx_rotate_old_fashion(opts):
    ...
    """
    my_ferry = FerryX()
    my_ferry.legacy_rotate(opts["instruction"])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {
            "test_name": "Rotate (-5, 8) waypoint around the ship with L90",
            "instruction": NavigationInstruction(action="L", value=90),
            "wp_coords": (-5, 8),
            "expected_facing": (-8, -5),
        },
        {
            "test_name": "Rotate (-5, 8) waypoint around the ship with R90",
            "instruction": NavigationInstruction(action="R", value=90),
            "wp_coords": (-5, 8),
            "expected_facing": (8, 5),
        },
        {
            "test_name": "Rotate (-9, -9) waypoint around the ship with L90",
            "instruction": NavigationInstruction(action="L", value=90),
            "wp_coords": (-9, -9),
            "expected_facing": (9, -9),
        },
        {
            "test_name": "Rotate (-9, -9) waypoint around the ship with R90",
            "instruction": NavigationInstruction(action="R", value=90),
            "wp_coords": (-9, -9),
            "expected_facing": (-9, 9),
        },
        {
            "test_name": "Rotate (20, 5) waypoint around the ship with L90",
            "instruction": NavigationInstruction(action="L", value=90),
            "wp_coords": (20, 5),
            "expected_facing": (-5, 20),
        },
        {
            "test_name": "Rotate (20, 5) waypoint around the ship with R90",
            "instruction": NavigationInstruction(action="R", value=90),
            "wp_coords": (20, 5),
            "expected_facing": (5, -20),
        },
        {
            "test_name": "Rotate (-2, -1) waypoint around the ship with R180",
            "instruction": NavigationInstruction(action="R", value=180),
            "wp_coords": (-2, -1),
            "expected_facing": (2, 1),
        },
...
def test_ferryx_rotate(opts):
    ...
    """
    my_ferry = FerryX()
    if "wp_coords" in opts.keys():
        my_ferry.wp_x_pos, my_ferry.wp_y_pos = opts["wp_coords"]
