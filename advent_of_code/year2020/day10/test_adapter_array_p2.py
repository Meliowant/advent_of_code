...
from advent_of_code.year2020.day10.adapter_array_p2 import (
    JoltageAdapter,
    solve_the_task,
)
    ...
    [
        {
            ...
            "next_ads": [],
            "check_second": False,
            "repr": "<JoltageAdapter(value='1', previous='None', "
            "next_nearest='None', possible_paths='0', "
            "next_adapters='[]')>",
        },
        {
            ...
            "check_second": False,
            "repr": (
                "<JoltageAdapter(value='1', previous='None', "
                "next_nearest='<JoltageAdapter("
                "value='2', previous='1', next_nearest='None', "
                "possible_paths='0', next_adapters='[]'"
                ")>', possible_paths='0', "
                "next_adapters='[2]')>"
            ),
        },
        {
            ...
            "next_ads": [2],
            "check_second": True,
            "repr": "<JoltageAdapter(value='2', previous='1', "
            "next_nearest='None', possible_paths='0', "
            "next_adapters='[]')>",
        },
        {
            ...
            "check_second": True,
            "repr": (
                "<JoltageAdapter(value='2', previous='1', "
                "next_nearest='"
                "<JoltageAdapter(value='3', previous='2', "
                "next_nearest='None', possible_paths='0', "
                "next_adapters='[]')>', "
                "possible_paths='0', "
                "next_adapters='[3]')>"
...
def test_get_pathes_amount(opts):
    """
    Check if our tree was built correctly.
    """
    init_adapter = JoltageAdapter(value=0)
    init_adapter.longest_path = (opts["adapters"], opts["adapters"][-1])
    got_paths_amount = init_adapter.get_paths_amount(opts["adapters"])
    assert got_paths_amount == opts["expected_paths_amount"]
...
def test_solve_the_task(opts):
    ...
    :return:
    """
    assert solve_the_task(opts["filename"]) == opts["exp_paths"]
